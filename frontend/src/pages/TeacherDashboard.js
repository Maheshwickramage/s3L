...
function TeacherDashboard({ user, onLogout, selectedClass, onBackToClasses }) {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      const [studentsRes, leaderboardRes, quizzesRes, resultsRes, chatRes, filesRes] = await Promise.all([
        authenticatedFetch(`http://98.84.104.233:5050/api/teacher/classes/${selectedClass.id}/students`),
        authenticatedFetch('http://98.84.104.233:5050/api/teacher/leaderboard'),
        authenticatedFetch(`http://98.84.104.233:5050/api/teacher/classes/${selectedClass.id}/quizzes`),
        authenticatedFetch('http://98.84.104.233:5050/api/teacher/results'),
        authenticatedFetch('http://98.84.104.233:5050/api/teacher/chat'),
        authenticatedFetch(`http://98.84.104.233:5050/api/teacher/classes/${selectedClass.id}/files`)
      ]);
  ...
  const handleAddStudent = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await authenticatedFetch('http://98.84.104.233:5050/api/teacher/students', {
        method: 'POST',
  ...
  const handleDeleteStudent = async (id) => {
    setLoading(true);
    try {
      const res = await authenticatedFetch(`http://98.84.104.233:5050/api/teacher/students/${id}`, {
        method: 'DELETE'
      });
  ...
  const handleCreateQuiz = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await authenticatedFetch('http://98.84.104.233:5050/api/teacher/quizzes', {
        method: 'POST',
  ...
  const handleDeleteQuiz = async (id) => {
    setLoading(true);
    try {
      const res = await authenticatedFetch(`http://98.84.104.233:5050/api/teacher/quizzes/${id}`, {
        method: 'DELETE'
      });
  ...
  const handleEditQuiz = async (quiz) => {
    try {
      const res = await authenticatedFetch(`http://98.84.104.233:5050/api/teacher/quizzes/${quiz.id}/full`);
      if (res.ok) {
  ...
  const handleSaveQuizEdit = async () => {
    ...
    try {
      // Update quiz title
      await authenticatedFetch(`http://98.84.104.233:5050/api/teacher/quizzes/${editQuizData.id}`, {
        method: 'PUT',
      ...
      for (const q of editQuestions) {
        await authenticatedFetch(`http://98.84.104.233:5050/api/teacher/quizzes/${editQuizData.id}/questions/${q.id}`, {
          method: 'PUT',
  ...
  const handleFinishQuiz = async () => {
    ...
    try {
      ...
      const res = await authenticatedFetch(`http://98.84.104.233:5050/api/teacher/quizzes/${newQuizId}/questions`, {
        method: 'POST',
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const res = await authenticatedFetch('http://98.84.104.233:5050/api/teacher/chat', {
        method: 'POST',
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      const res = await authenticatedFetch(`http://98.84.104.233:5050/api/teacher/classes/${selectedClass.id}/files`, {
        method: 'POST',
  ...
  const handleDeleteFile = async (fileId) => {
    try {
      const res = await authenticatedFetch(`http://98.84.104.233:5050/api/teacher/files/${fileId}`, {
        method: 'DELETE'
      });

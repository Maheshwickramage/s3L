  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const analyticsRes = await authenticatedFetch('https://52.23.173.216:5050/api/student/analytics');
        ...
        // Load quiz history
        const historyRes = await authenticatedFetch('https://52.23.173.216:5050/api/student/quiz-history');
